...
const validationSchema = Yup.object({
  fname: Yup.string().required("Please enter your full name").min(6,"Please enter your full name").max(20,"Please enter a valid name"),
  emailAddress: Yup.string().email("Please enter a valid Email Address").required("Email Address required."),
    ...
    <section className="signin-wrapper">
      ...
      <div className="signin-card">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="form-group">
            <label>Role:</label>
            <select name="role" id="role" values={formik.values.role} onChange={formik.handleChange} onBlur={formik.handleBlur}>
